<template>
    <transition leave-active-class="duration-400" leave-to-class="opacity-0">
...
<script setup>
import { InformationCircleIcon, XMarkIcon, CheckCircleIcon, ExclamationTriangleIcon, XCircleIcon } from '@heroicons/vue/24/outline';
...
const containerClass = computed(() => {
    return cva("fixed w-[350px] right-4 top-4 flex p-4 rounded-md space-x-3", {
        variants: {
            intent: {
                info: "bg-blue-100",
