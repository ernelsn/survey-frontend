  ...
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div class="flex items-center mt-5">
        <div class="w-full h-0.5 border-b border-gray-900/10 dark:bg-gray-700"></div>
        <div class="px-5 text-sm text-center text-gray-500 dark:text-gray-500">Or</div>
        <div class="w-full h-0.5 border-b border-gray-900/10 dark:bg-gray-700"></div>
      </div>

      <div id="third-party-auth" class="flex flex-col gap-2 justify-center mt-5">
        <button v-for="provider in providers" :key="provider.name" @click="handleSocialLogin(provider.name)"
          ...
          <span v-html="provider.svg" class="h-6 w-6 mr-2"></span>
...
const providers = ref([
  {
    name: 'Google',
    svg: `<svg class="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
